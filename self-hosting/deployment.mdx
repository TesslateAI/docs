...
<CardGroup cols={2}>
  ...
  <Card title="Required Components" icon="puzzle-piece">
    - kubectl configured
...
<Steps>
  <Step title="Configure Environment">
    ...
    Key variables:
    ```env
    K8S_DEVSERVER_IMAGE=your-registry/tesslate-devserver:latest
  ...
  <Step title="Deploy All Components">
    ```bash
...
<Steps>
  <Step title="Hydration (Pod Start)">
  ...
  <Step title="Dehydration (Pod Stop)">

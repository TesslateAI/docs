...
<Tabs>
  ...
  <Tab title="Shell Operations">
    ...
    | `session` | Persistent shell sessions for complex workflows |
  </Tab>

  <Tab title="Web Operations">
    | Tool | Description |
    |------|-------------|
    | `fetch` | Make HTTP requests to external APIs |
    | `search` | Search the web for documentation or solutions |
  </Tab>

  <Tab title="Planning">
    | Tool | Description |
    |------|-------------|
    | `todos` | Create and manage task lists |
    | `metadata` | Query project information |
  </Tab>
</Tabs>
